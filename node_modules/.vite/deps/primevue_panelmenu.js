...
// node_modules/primevue/panelmenu/style/panelmenustyle.esm.js
var classes = {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", {
    ...
    }, $options.getPTOptions("icon", processedItem, index)), null, 16)) : createCommentVNode("", true), createBaseVNode("span", mergeProps({
      "class": _ctx.cx("label")
...
var script4 = {
  ...
  methods: {
    ...
    getPTOptions: function getPTOptions2(key, item, index) {
      return this.ptm(key, {
        context: {
          index,
    ...
    getMenuItemProps: function getMenuItemProps2(item, index) {
      return {
        icon: mergeProps({
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    }, $options.getPTOptions("headerIcon", item, index)), null, 16)) : createCommentVNode("", true), createBaseVNode("span", mergeProps({
