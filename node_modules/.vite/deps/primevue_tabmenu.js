...
// node_modules/primevue/tabmenu/style/tabmenustyle.esm.js
var classes = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    }, $options.getPTOptions("icon", item, i)), null, 16)) : createCommentVNode("", true), createBaseVNode("span", mergeProps({
      "class": _ctx.cx("label")
