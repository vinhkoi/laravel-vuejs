import {
  ...
  script2 as script18,
  script3 as script19
} from "./chunk-TENECTCU.js";
import {
  script as script16
} from "./chunk-IDUQ2XIW.js";
import {
  script as script15
} from "./chunk-JDVQ4FKF.js";
import {
  script as script14
} from "./chunk-MIH635IU.js";
import {
  script as script13
} from "./chunk-TQ6ULFM6.js";
import "./chunk-NGZBJUCH.js";
import "./chunk-NRRNRLG2.js";
import "./chunk-C3RQHGRP.js";
import "./chunk-WZIQDVO2.js";
import "./chunk-PWGT64QN.js";
import {
  script as script12
} from "./chunk-MJCHQYHD.js";
import "./chunk-5CID2STM.js";
import {
  FocusTrap
} from "./chunk-KI6BULK3.js";
import {
  script as script11
} from "./chunk-BJEDNEHF.js";
import {
  script as script10
} from "./chunk-SGOVEDZR.js";
import {
  script as script9
} from "./chunk-GXDE5TI4.js";
import "./chunk-FLTFEKUE.js";
import {
  script as script8
} from "./chunk-2OIMPIWS.js";
import {
  OverlayEventBus
} from "./chunk-LRWJDVBP.js";
import {
  script as script7
} from "./chunk-KNJAZ2DS.js";
import {
  script as script6
} from "./chunk-3QBGFEEQ.js";
import {
  script as script5
} from "./chunk-MJY7RY73.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-VB5DEVFV.js";
import {
  script as script4
} from "./chunk-UYXYKRSM.js";
import {
  script as script3
} from "./chunk-A35EVOBL.js";
import {
  Ripple
} from "./chunk-PZ6OZJ6A.js";
import {
  script as script2
} from "./chunk-2MUZOTOH.js";
import "./chunk-MK53LPDB.js";
import "./chunk-PDBQ4OYH.js";
import {
  script
      ...
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            filterModel: $props.filters[$props.field],
            filterCallback: $options.filterCallback
          }, null, 8, ["field", "filterModel", "filterCallback"]))], 16, _hoisted_27)), [[_directive_focustrap]]) : createCommentVNode("", true)];
        }),
        _: 1
...
var script$2 = {
  ...
  components: {
    ...
    SortAltIcon: script17,
    SortAmountUpAltIcon: script19,
    SortAmountDownIcon: script18
  }
};
...
var _hoisted_17 = ["tabindex", "colspan", "rowspan", "aria-sort", "data-p-sortable-column", "data-p-resizable-column", "data-p-highlight", "data-p-filter-column", "data-p-frozen-column", "data-p-reorderable-column"];
...
var script26 = {
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      data10.sort(function(data1, data22) {
      ...
      for (var i = 0; i < data10.length; i++) {
            ...
            if (filterMeta.operator) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                  ...
                  localMatch = this.executeLocalFilter(filterField, data10[i], filterConstraint);
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](ObjectUtils.resolveFieldData(data10[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
    ...
    onSpaceKey: function onSpaceKey(event2, rowData, rowIndex2, slotProps) {
      ...
      if (event2.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = ObjectUtils.findIndexInList(this.selection[0], data10);
          lastSelectedRowIndex = ObjectUtils.findIndexInList(this.selection[this.selection.length - 1], data10);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = ObjectUtils.findIndexInList(this.selection, data10);
        }
    ...
    onTabKey: function onTabKey(event2, rowIndex2) {
      var body = this.$refs.bodyRef && this.$refs.bodyRef.$el;
      var rows2 = DomHandler.find(body, 'tr[data-p-selectable-row="true"]');
      if (event2.code === "Tab" && rows2 && rows2.length > 0) {
        ...
        if (firstSelectedRow) {
          ...
          rows2[0].tabIndex = "0";
          focusedItem !== rows2[0] && (rows2[rowIndex2].tabIndex = "-1");
        }
      }
    },
    ...
    findLastSelectableRow: function findLastSelectableRow() {
      var rows2 = DomHandler.find(this.$refs.table, 'tr[data-p-selectable-row="true"]');
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            this.d_selectionKeys[String(ObjectUtils.resolveFieldData(data10, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this.d_editingRowKeys[String(ObjectUtils.resolveFieldData(data10, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    exportCSV: function exportCSV(options, data10) {
      var _this6 = this;
      var csv = "\uFEFF";
      if (!data10) {
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event2 = e.originalEvent;
      var data10 = e.data;
      var groupFieldValue = ObjectUtils.resolveFieldData(data10, this.groupRowsBy);
  ...
  components: {
    DTPaginator: script13,
    DTTableHeader: script$1,
    DTTableBody: script$7,
    DTTableFooter: script$5,
    DTVirtualScroller: script8,
    ArrowDownIcon: script20,
    ArrowUpIcon: script21,
    SpinnerIcon: script5
  }
};
function _typeof(o) {
