    ...
    <div>
      ...
      >
        <div class="confirmation-content">
          ...
          <span v-if="bannerr"
            >Are you sure you want to delete <b>{{ bannerr.title }}</b
            >?</span
          >
        </div>
        <template #footer>
...
const AddProduct = async () => {
  ...
  try {
    await router.post("banners/store", formData, {
      onSuccess: (page) => {
        Swal.fire({
          toast: true,
          icon: "success",
...
const updateProduct = async () => {
  const formData = new FormData();
  formData.append("title", bannerr.value.title);
  ...
  try {
    await router.post("banners/update/" + bannerr.value.id, formData, {
      onSuccess: (page) => {
        Swal.fire({
          toast: true,
          icon: "success",
...
const deleteProduct = () => {
  try {
    router.delete("banners/destroy/" + bannerr.value.id, {
      onSuccess: (page) => {
        Swal.fire({
          toast: true,
          icon: "success",
