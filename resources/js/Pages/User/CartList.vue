...
// }
function submit() {
  router.visit(route("checkout.vnpay"), {
    method: "post",
    data: {
      carts: usePage().props.cart.data.items,
      products: usePage().props.cart.data.products,
...
//   // Dựa vào phương thức thanh toán được chọn

//   if (paymentMethod === "stripe") {
//     // Gửi dữ liệu thanh toán cho Stripe
//     router.visit(route("stripe.checkout"), {
//       method: "post",
//       data: {
//         carts: usePage().props.cart.data.items,
//         products: usePage().props.cart.data.products,
...
//     // Gửi dữ liệu thanh toán cho VNPAY
//     router.visit(route("vnpay.index"), {
//       method: "post",
//       data: {
//         carts: usePage().props.cart.data.items,
//         products: usePage().props.cart.data.products,
        ...
        >
          ...
          <form @submit.prevent="submit">
            ...
            <!-- <button
              v-if="formFilled || userAddress"
              type="button"
              onclick="paymentMethod = 'stripe'; submit()"
              class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
            >
            ...
            <button
              v-if="formFilled || userAddress"
              type="button"
              onclick="paymentMethod = 'vnpay'; submit()"
              class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
            >
              Checkout with VNPAY
            </button> -->
