...
//       // Cập nhật biến showNoResults nếu không có sản phẩm được tìm thấy
//       this.showNoResults = response.data.products.length === 0;
//     } else {
//       // Nếu không có dữ liệu, hiển thị thông báo hoặc xử lý theo cách phù hợp
